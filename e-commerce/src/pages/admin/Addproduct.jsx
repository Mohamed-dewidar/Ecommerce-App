...
export function Addproduct() {
  ...
  let removeimage = (e) => {
    setFormvalues({
      ...formvalues,
      images: formvalues.images.filter((element, index, array) => {
  ...
  let deleteelement = (id, category) => {
    axios
      .delete(
        `http://localhost:3005/${AllCategories[parseInt(category) - 1]}/${id}`,
      )
      .then((response) => {
          ...
          <Form className="" onSubmit={formOperation}>
            ...
            <Form.Group className="mb-3">
              ...
              <div className="d-flex align-items-center">
                ...
                <div className="ms-auto">
                  <i className="fs-2 bi bi-currency-dollar"></i>
                </div>
              </div>
              {errors.price && (
                <div className="text-danger">
            ...
            <Form.Group className="mb-3">
              ...
              <Form.Control
                ...
                defaultValue={formvalues.discountPercentage}
                onChange={handleChange}
                max="90"
              />
              {errors.discount && (
                <div className="text-danger">
                  Discount percentage cannot be greater than 90 or less than
                  zero
                </div>
              )}
            </Form.Group>
              ...
              <div className="d-flex align-items-center">
                <div className="w-100">
                  <Form.Control
                    type="text"
                    name="thumbnail"
                    placeholder="ain image url addresss"
                    defaultValue={formvalues.thumbnail}
                    onChange={handleChange}
                  />
                </div>
                <i
                  className="text-success fs-2 bi bi-plus-square-fill m-1"
                  onClick={addimage}
                ></i>
              </div>
            </Form.Group>
            ...
            {formvalues.images && formvalues.images.length > 0 ? (
              <Form.Group className="mb-3">
                {formvalues.images.map((imageUrl, i) => (
                  <div
                    key={imageUrl}
                    className=" d-flex felx-nowrap align-items-center"
                  >
                    <span className="m-1"> image{i + 1}: </span>{" "}
                    <div className="w-100">
                      <Form.Control
                        className="m-1"
                        type="text"
                    ...
                    <div className="p-1" onClick={removeimage}>
                      <i class="m-1 text-danger fs-2 bi bi-x-square-fill"></i>
                    </div>
                  </div>
                ))}
              </Form.Group>
            ...
            <div className="d-flex justify-content-around">
              ...
              {formvalues.id ? (
                <div
                  onClick={() =>
                    deleteelement(formvalues.id, formvalues.category_id)
                  }
                >
