    ...
    <>
      ...
      <div>
          ...
          <div className=" parentcontainer ">
                ...
                <div className="d-felx flex-column imagestotherightcontianer ">
                  <div className=" produductDetailsImages">
                    <img
                      ...
                      alt="product image"
                      onClick={() => changepic(product.thumbnail)}
                    />
                  </div>
            ...
            <div className="infocontainer ">
              ...
              {product.discountPercentage > 0 ? (
                <div>
                  <del>USD{product.price}</del> ({product.discountPercentage} %
                  Off)
                </div>
              ) : null}
              <div>
        ...
        <div className="container d-flex justify-content-around">
          <NavLink
            to={`/admin/${product.seller}/${product.category_id}/${product.id}/edit`}
          >
      ...
      <NavLink to={`/admin/${user}/product/0/edit`}>
        <div className="addbutton">
          <i className=" text-dark fs-1 bi bi-plus-circle-fill"></i>
        </div>
      </NavLink>
    </>
  );
